/* Dao Quang Duc - 20223693 - ET1 - HUST
 * =======================================================================================================================================*                           
 *                                                   Mạch điều khiển đèn giao thông ngã ba
 * Đấu nối: 
 + Modul Led 7 thanh:
 ...
 + Led đơn:
  -A0: Chân Arduino điều khiển LED xanh 1                                                 -A3: Chân Arduino điều khiển LED xanh 2 
  -A1: Chân Arduino điều khiển LED vàng 1                                                 -A4: Chân Arduino điều khiển LED vàng 2
  -A2: Chân Arduino điều khiển LED đỏ 1                                                   -A5: Chân Arduino điều khiển LED đỏ 2
 */
...
unsigned char led7Hex[] = {0xC0, 0xF9, 0xA4, 0xB0, 0x99, 0x92, 0x82, 0xF8, 0x80, 0x90};   // Mã LED 7 thanh kiểu anot +
